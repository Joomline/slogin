...
<form action="<?php echo Route::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form">
    ...
    <div class="login-greeting">
        <?php echo Text::sprintf('MOD_SLOGIN_HINAME', htmlspecialchars($user->get('name')));	 ?>
    </div>
		<ul class="ul-jlslogin">
            ...
            <?php if ($show_fusion_form == 1) {?>
                <li>                    
					...
					<p><?php echo Text::_('MOD_SLOGIN_ATTACH_PROVIDERS_MODULE')?></p>
	...
	<input type="submit" name="Submit" class="button" value="<?php echo Text::_('JLOGOUT'); ?>" />
...
<div id="slogin-buttons" class="slogin-buttons slogin-compact">
    <?php if (count($plugins)): ?>
        ...
        foreach($plugins as $link):
            ...
            ?>
            <a  rel="nofollow" <?php echo $linkParams.$title;?> href="<?php echo Route::_($link['link'] . ($fusionItemId ? '&Itemid=' . $fusionItemId : '')); ?>"><span class="<?php echo $link['class'];?>">&nbsp;</span></a>
        <?php endforeach; ?>
    <?php endif; ?>
</div>
