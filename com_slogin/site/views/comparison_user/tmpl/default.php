...
<div class="login">
    ...
    <h1>
        <?php echo Text::_('COM_SLOGIN_COMPARISON'); ?>
    </h1>

    <div class="login-description">
        <?php echo Text::sprintf('COM_SLOGIN_COMPARISON_DESC', $this->email); ?>
    </div>
        ...
        <fieldset>
            <div class="login-fields">
                <label id="username-lbl" for="username" class=" required">
                    <?php echo Text::_('COM_SLOGIN_USERNAME_LABEL'); ?>
            ...
            <div class="login-fields">
                <label id="password-lbl" for="password" class=" required">
                    <?php echo Text::_('COM_SLOGIN_PASS'); ?>
                    <span class="star">&nbsp;*</span>
                </label>
                <input type="password" name="password" id="password" value=""
                       class="validate-password required" size="25">
            </div>
            <button type="submit" class="button btn btnslogin"><?php echo Text::_('COM_SLOGIN_JOIN'); ?></button>
    ...
    <?php echo Text::_('COM_SLOGIN_LOST_PASS'); ?>

    <form id="user-registration" action="<?php echo Route::_('/index.php?option=com_users&task=reset.request') ?>" method="post"
          class="form-validate">
        <p><?php echo Text::_('COM_SLOGIN_LOST_PASS_DESC'); ?></p>
        <fieldset>
        ...
        <button type="submit" class="validate btn btnslogin"><?php echo Text::_('COM_SLOGIN_SUBMIT'); ?></button>
        <?php echo HTMLHelper::_('form.token'); ?>
    </form>
</div>