...
class plgSlogin_authTwitch extends CMSPlugin
{
    public function onSloginAuth()
    {
        $redirect = Uri::base().'?option=com_slogin&task=check&plugin=twitch';
    ...
    public function onCreateSloginLink(&$links, $add = '')
    {
        ...
        $links[$i]['plugin_title'] = Text::_('COM_SLOGIN_PROVIDER_TWITCH');
    }
}
