...
class plgSlogin_authWordpress extends CMSPlugin
{
    public function onSloginAuth()
    {
        $redirect = Uri::base().'?option=com_slogin&task=check&plugin=wordpress';
    ...
    public function onCreateSloginLink(&$links, $add = '')
    {
        ...
        $links[$i]['plugin_title'] = Text::_('COM_SLOGIN_PROVIDER_WP');
    }
}
